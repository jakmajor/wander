        ...
        <div style={{background: '#ffffff', boxShadow: '0px 10px 30px 12px rgba(23, 57, 89, 0.05)', borderRadius: '8px', padding: '0px', overflow: 'hidden',marginBottom: '20px'}} className={`container`}>
                  <div className="row outside-border">
                    <div className="col-md-4">
                      <div style={{ backgroundImage: `url(https://images.unsplash.com/photo-1472396961693-142e6e269027?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=952&q=80)`, backgroundSize: 'cover', backgroundPosition: 'center',height: '100%',minHeight: '300px',width: '100%' }}></div>
                    </div>
